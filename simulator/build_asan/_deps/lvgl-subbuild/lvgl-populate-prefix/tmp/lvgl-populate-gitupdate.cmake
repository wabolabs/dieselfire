...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v9.5.0"
  WORKING_DIRECTORY "/home/kboran/Nextcloud/development/dieselfire/DieselFire/simulator/build_asan/_deps/lvgl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/kboran/Nextcloud/development/dieselfire/DieselFire/simulator/build_asan/_deps/lvgl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kboran/Nextcloud/development/dieselfire/DieselFire/simulator/build_asan/_deps/lvgl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

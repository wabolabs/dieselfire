# DieselFire - Design Document

## Project Overview

DieselFire is a modernized controller for generic Chinese diesel heaters, forked from the original [DieselFire](https://dieselfire.wabo.cc) project. This document describes the complete hardware and firmware design.
